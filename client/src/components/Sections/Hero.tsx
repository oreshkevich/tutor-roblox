...
export function Hero() {
  ...
  return (
    <section className='relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden'>
      ...
      <div
        className='blob-shape bg-secondary/20 w-[400px] h-[400px] bottom-0 -left-20'
        style={{animationDelay: '2s'}}
      ></div>
      <div
        className='blob-shape bg-accent/20 w-[300px] h-[300px] top-40 left-1/3'
        ...
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-8 items-center'>
          ...
          >
            ...
            <h1 className='text-4xl sm:text-5xl lg:text-6xl font-display font-bold leading-tight text-balance mb-6'>
              Откройте мир{' '}
              <span className='text-gradient'>программирования</span> для вашего
              ребенка
            </h1>

            <p className='text-lg sm:text-xl text-foreground/70 mb-8 leading-relaxed'>
              Индивидуальные онлайн-занятия, где мы не просто пишем код, а
              учимся мыслить логически, создавать собственные игры и сайты.
            </p>
          ...
          >
            <div className='relative rounded-[2.5rem] overflow-hidden shadow-2xl border-4 border-white transform rotate-2 hover:rotate-0 transition-transform duration-500'>
              ...
              <picture>
                <source srcSet='/images/p.avif' type='image/avif' />
                <source srcSet='/images/p.webp' type='image/webp' />
                <img
                  src='/images/p.jpg'
            ...
            {/* Floating badges */}
            <div
              className='absolute -left-8 top-12 bg-white p-4 rounded-2xl shadow-xl border border-border/50 animate-bounce'
            ...
            <div
              className='absolute -right-6 bottom-12 bg-white p-4 rounded-2xl shadow-xl border border-border/50 animate-bounce'
